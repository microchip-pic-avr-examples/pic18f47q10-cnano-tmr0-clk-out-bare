...
<br>A GPIO pin is configured as output and a 125 Hz signal is generated on the GPIO pin (RC2) using the Peripheral Pin Select (PPS).
...
<br><img src="images/TMR0-clk-out-bare-main-project.png" width="600">
